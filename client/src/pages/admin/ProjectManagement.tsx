                  ...
                  {filteredProjects.map((project: Project) => (
                    <TableRow key={project.id}>
                      ...
                      <TableCell className="font-medium">
                          <div>
                            <div className="text-green-600">${parseFloat(project.price).toLocaleString()}</div>
                            <div className="text-xs text-muted-foreground">
                              ₲ {exchangeRate ? Math.round(parseFloat(project.price) * parseFloat(exchangeRate.usdToGuarani)).toLocaleString('es-PY') : 'Cargando...'}
                            </div>
                          </div>
                        </TableCell>
                      <TableCell>
            ...
            {selectedProject && (
              <Tabs defaultValue="details" className="w-full">
                <TabsList className="grid w-full grid-cols-5">
                  ...
                  <TabsTrigger value="payment-stages">Etapas de Pago</TabsTrigger>
                ...
                <TabsContent value="payment-stages" className="space-y-6">
                    {selectedProject && (
