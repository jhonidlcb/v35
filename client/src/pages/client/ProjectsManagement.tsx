      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-1">
            ...
            <TabsTrigger value="budget" className="text-xs sm:text-sm">Negociación</TabsTrigger>
            <TabsTrigger value="payments" className="text-xs sm:text-sm">Pagos</TabsTrigger>
            <TabsTrigger value="communication" className="text-xs sm:text-sm">Comunicación</TabsTrigger>
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                        <p className="text-sm text-muted-foreground">
                          <strong>Precio USD:</strong> ${parseFloat(selectedProject.price).toLocaleString()}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          <strong>Equivalente PYG:</strong> ₲ {exchangeRate ? Math.round(parseFloat(selectedProject.price) * parseFloat(exchangeRate.usdToGuarani)).toLocaleString('es-PY') : 'Cargando...'}
                        </p>
                        {exchangeRate && (
                          <p className="text-xs text-muted-foreground italic">
                            Tipo de cambio: 1 USD = ₲ {parseFloat(exchangeRate.usdToGuarani).toLocaleString('es-PY')}
                          </p>
                        )}
                      </div>
                  </div>
